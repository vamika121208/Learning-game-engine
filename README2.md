...
The learning game engine follows a modular architecture where game logic, content, and user interface are separated. The engine loads game configurations defined in JSON files and dynamically initializes the appropriate game module.
...
This architecture enables new educational games to be generated by modifying configuration files without changing the engine code.
---
 System Architecture
